...
public class PageIntercept implements Interceptor{
    ...
    public void setDatabaseType(String databaseType) throws Exception {
        if (!databaseType.equalsIgnoreCase(MYSQL) && !databaseType.equalsIgnoreCase(ORACLE)) {
            throw new Exception("Page not support for the type of database, database type [" + databaseType + "]");
        }
